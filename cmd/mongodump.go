...
var (
	mongoDumpCmd = &cobra.Command{
		...
		Run: func(cmd *cobra.Command, args []string) {
			...
			err := source.DoBackupForKind(ctx, mongodump.Kind, cleanup, useRestic, useResticForget, listResticSnapshots,
				doResticCheck, doResticPrune, rebuildResticIndex, resticTags)
			if err != nil {
				panic(err)
			}
		},
